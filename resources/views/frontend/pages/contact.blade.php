        ...
        <div class="col-lg-8 col-12">
          <div class="form-main">
            <div class="title">
              ...
              @endphp
              <h4>Get in touch</h4>
              <h3>Write us a message @auth @else<span style="font-size:12px;" class="text-danger">[You need to login
                  first]</span>@endauth</h3>
            </div>
        ...
        <div class="col-lg-4 col-12">
          <div class="single-head">
            ...
            <div class="single-info">
              ...
              <ul>
                <li><a href="mailto:info@yourwebsite.com">@foreach($settings as $data) {{$data->email}} @endforeach</a>
                </li>
              </ul>
            </div>
            <div class="single-info">
...
<div class="map-section">
  <div id="myMap">
    <iframe
      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3956.9439942140098!2d112.69002917330558!3d-7.360175172418752!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd7e35205623155%3A0x2b06cb3a547213ba!2sTaman%20Indah%20Regency%20blok%20BC-11!5e0!3m2!1sid!2sid!4v1703529051763!5m2!1sid!2sid"
